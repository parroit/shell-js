(function() {
    ...
    window.onload = function() {
        ...
        term.currentLine = function(){
            return this.lines[this.y + this.ybase].map(function(cell){return cell[1]}).join("").trim()
        ...
        term.on('data', function(data) {
            if (controller.currentProcess.mode === "character") {
            ...
            if (data === "\r") {
                ...
                var cmd = term.currentLine();
                term.write("\n");
                controller.currentProcess.write(cmd);
            }
